...
export const versionUpdates: VersionUpdate[] = [
  {
    ...
    description:
      "v1.2 把活动信息和用户组队拆成更清楚的两条路径：活动发现页用于看真实活动信息，组队大厅用于看正在约人的车队。同时补齐好友入口、评论回复、举报处理、运营数据和游客访问体验。",
    highlights: [
      "活动信息和组队逻辑彻底拆清楚",
      "组队大厅和组局发布页更符合真实使用场景",
      "好友、评论、举报和通知补齐活动前沟通",
    ...
    userUpdates: [
      "活动发现页继续保留原来的卡片浏览体验，但活动信息和车队会用更清楚的标签和操作区分。",
      "从公开来源导入的活动会作为活动信息展示，不再强行显示报名人数、名额和 0/99 这类误导信息。",
      "用户可以先查看一个活动信息，再基于这个活动发起自己的组队。",
      "已经存在的车队不再继续派生新的车队，避免组队层级混乱。",
      "组队大厅集中展示正在约人的车队，适合查看自己、好友和平台上的组队机会。",
      "组队大厅增加更清楚的筛选、空状态和移动端布局，用户不会一进页面就被大量说明挡住。",
      "“我来组局”发布页改为组队语义，不再使用容易混淆的创建活动文案。",
